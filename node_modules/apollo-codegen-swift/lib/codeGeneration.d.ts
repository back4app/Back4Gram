...
export declare class SwiftAPIGenerator extends SwiftGenerator<CompilerContext> {
    ...
    fileHeader(): void;
    classDeclarationForOperation(operation: Operation, outputIndividualFiles: boolean): void;
    structDeclarationForFragment({ fragmentName, selectionSet, source }: Fragment, outputIndividualFiles: boolean): void;
