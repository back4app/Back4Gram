...
export declare function getOperationRootType(schema: GraphQLSchema, operation: OperationDefinitionNode): import("graphql/tsutils/Maybe").default<GraphQLObjectType<any, any, {
    [key: string]: any;
}>>;
